...
public class DeskPlaner {
	 ...
	 * <i>In der Metode wird der eingegebene String aus der Konsole in einzelne W�rter aufgeteilt.
	 * Das erste Wort ist das Label, alle anderen W�rter werden in args gespeichert.<i>
	 * 
	 * @author Andr� Sommer
	 */
